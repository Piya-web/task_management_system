...
SECRET_KEY = "django-insecure-%isfux+(9g0uy1ekoqgkdn*d6nkfr8p+8^g%+ia(-f(q0x-9wm"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "boards.context_processors.sidebar_data",
            ],
        },
    },
]
...
# -------------------------------------------------------------------
LOGIN_REDIRECT_URL = '/boards/'          # where users go after logging in
